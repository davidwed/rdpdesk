...
BEGIN_EVENT_TABLE(FRDPOptionsDialog_General, wxPanel)
EVT_CHECKBOX (ID_FRDP_CHECKBOX_CUSTOMPORT, FRDPOptionsDialog_General::checkbox_customport_func)
EVT_TEXT(ID_FRDP_TEXTCTRL_PASSWORD, FRDPOptionsDialog_General::text_passwordentry_func)
EVT_CHECKBOX (ID_FRDP_CHECKBOX_AUTOLOGON, FRDPOptionsDialog_General::text_passwordentry_func)
END_EVENT_TABLE()

BEGIN_EVENT_TABLE(FRDPOptionsDialog_Display, wxPanel)
EVT_RADIOBUTTON (ID_FRDP_CHK_CONTROLSIZE, FRDPOptionsDialog_Display::checkbox_controlsize_func)
END_EVENT_TABLE()

BEGIN_EVENT_TABLE(FRDPOptionsDialog_Program, wxPanel)
EVT_CHECKBOX(ID_FRDP_CHECKBOX_USE_PROGRAM, FRDPOptionsDialog_Program::checkbox_program_func)
END_EVENT_TABLE()

BEGIN_EVENT_TABLE(FRDPOptionsDialog_Performance, wxPanel)
EVT_COMBOBOX(ID_FRDP_COMBOBOX_SPEED, FRDPOptionsDialog_Performance::choise_speed_func)
END_EVENT_TABLE()
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog::FRDPOptionsDialog(wxWindow *parent_element)
: parent(NULL),
   rdp_general(NULL),
   rdp_display(NULL),
   rdp_share(NULL),
   ...
   rdp_advanced(NULL)
{
   ...
   {
      error = FRDP_ERROR_PARENT_IS_NULL;
   }
}
...
int FRDPOptionsDialog::Build()
{
   if ( error == 0 )
   {
      ...
      if ( state == false)
      {
	 error = FRDP_ERROR_CANT_CREATE_NOTEBOOK;
      }
      else
      {
	 rdp_general = new FRDPOptionsDialog_General (this);
	 rdp_general->SetGroupList(array_string_group_list);

	 rdp_general->Build();
	 rdp_display = new FRDPOptionsDialog_Display (this);
	 rdp_display->Build();
	 rdp_share = new FRDPOptionsDialog_Share (this);
	 rdp_share->Build();
	 rdp_program = new FRDPOptionsDialog_Program (this);
	 rdp_program->Build();
	 rdp_perfomance = new FRDPOptionsDialog_Performance (this);
	 rdp_perfomance->Build();
	 rdp_advanced = new FRDPOptionsDialog_Advanced (this);
	 rdp_advanced->Build();

	 AddPage(rdp_general,    _("General"));
	 AddPage(rdp_display,    _("Display"));
	 AddPage(rdp_share,      _("Share"));
	 AddPage(rdp_program,    _("Program"));
	 AddPage(rdp_perfomance, _("Perfomance"));
	 AddPage(rdp_advanced,   _("Advanced"));
	 //this->Show();
#ifdef __WXMSW__
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog::SetOptions (const Options_HashMap *options) {
   bool state = false;
...
void FRDPOptionsDialog::SetGroupList(const wxArrayString &group_list)
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog::GetOptions ()
{
   //
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_General::FRDPOptionsDialog_General(FRDPOptionsDialog *parent_element)
{
   parent = NULL;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_General::~FRDPOptionsDialog_General()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_General::Build()
{
   if ( error == 0 )
   {
      bool state = false;
      ...
      if ( state == false)
      {
	 error = FRDP_ERROR_CANT_CREATE_PANEL;
      }
      else
      {
...
//	 }
	 ...
	 m_checkbox_customport = new wxCheckBox( this, ID_FRDP_CHECKBOX_CUSTOMPORT,
	 ...
	 m_static_password = new wxStaticText(this, wxID_ANY, _("Password"),wxDefaultPosition,
					      wxDefaultSize);
	 m_text_password = new wxTextCtrl( this, ID_FRDP_TEXTCTRL_PASSWORD, wxT(""),wxDefaultPosition,
					   wxDefaultSize, wxTE_PASSWORD);
	 m_checkbox_autologon = new wxCheckBox( this, ID_FRDP_CHECKBOX_AUTOLOGON, _("&Auto logon"),
						wxDefaultPosition,wxDefaultSize );
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_General::get_group_list()
{
   // Benc bc;
...
void FRDPOptionsDialog_General::checkbox_customport()
{
...
void FRDPOptionsDialog_General::checkbox_customport_func(wxCommandEvent &event)
{
   checkbox_customport();
}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_General::text_passwordentry_func(wxCommandEvent &event)
{
   wxString strTemp;
   switch(event.GetId())
   {
      case ID_FRDP_TEXTCTRL_PASSWORD:
	 ...
	 break;
      ...
      case ID_FRDP_CHECKBOX_AUTOLOGON:
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog_General::Get_Options()
{
   Options_HashMap local_options;
   FRDP_ERRORS error = FRDP_ERROR_OK;
   ...
   {
      error = FRDP_ERROR_EMPTY_HOSTNAME;
   }
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog_General::SetOptions(const Options_HashMap *all_options)
{
   bool state = false;
   Options_HashMap local_options;
...
void FRDPOptionsDialog_General::SetGroupList(const wxArrayString &group_list)
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Display::FRDPOptionsDialog_Display(FRDPOptionsDialog *parent_element)
{
   m_boxsizer_1 = NULL;
   m_boxsizer_2 = NULL;
   m_boxsizer_3 = NULL;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_Display::Build()
{
   if (error == 0 )
   {
      bool state = false;
	 ...
	 m_radiobutton_controlsize = new wxRadioButton(this, ID_FRDP_CHK_CONTROLSIZE,
						       _("&Control size"),
						       wxDefaultPosition, wxDefaultSize, 0,
						       wxDefaultValidator);
	 m_radiobutton_controlsize->SetValue(true);
	 m_radiobutton_fullscreen = new wxRadioButton(this, ID_FRDP_CHK_CONTROLSIZE,
						      _("&Full screen"),
						      wxDefaultPosition, wxDefaultSize, 0,
						      wxDefaultValidator);
	 m_radiobutton_customgeometry = new wxRadioButton(this, ID_FRDP_CHK_CONTROLSIZE,
							  _("&Custom geometry"),
							  wxDefaultPosition, wxDefaultSize, 0,
							  wxDefaultValidator);
	 m_radiobutton_presetsize = new wxRadioButton(this, ID_FRDP_CHK_CONTROLSIZE,
						      _("&Preset geometry"),
						      wxDefaultPosition, wxDefaultSize, 0,
						      wxDefaultValidator);
...
//													 wxDefaultPosition, wxDefaultSize );
	 ...
	 m_static_colordepth = new wxStaticText(this, wxID_ANY, _("Color depth"),wxDefaultPosition,
						wxDefaultSize);
	 wxString Choises[] = {_("8-bit"),
			       _("15-bit"),
			       _("16-bit"),
			       _("24-bit"),
			       _("32-bit")};
	 m_choise_colordepth = new wxComboBox(this,
					      wxID_ANY,
					      wxT(""),
					      wxDefaultPosition,
					      wxDefaultSize,
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
wxArrayString FRDPOptionsDialog_Display::GetResolutionsList()
{
   wxDisplay disp;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
wxSize FRDPOptionsDialog_Display::GetResolution(int i)
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_Display::GetDefaultResolution()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Display::CheckFRDPDisplay()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Display::checkbox_customgeometry_func(wxCommandEvent& event)
{
   CheckFRDPDisplay();
}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Display::checkbox_fullscreen_func(wxCommandEvent &event)
{
   CheckFRDPDisplay();
}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Display::checkbox_controlsize_func(wxCommandEvent &event)
{
   CheckFRDPDisplay();
}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Display::~FRDPOptionsDialog_Display()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog_Display::Get_Options()
{
   Options_HashMap local_options;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog_Display::SetOptions(const Options_HashMap *all_options)
{
   bool state = false;
   Options_HashMap local_options;
   local_options = *all_options;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Share::FRDPOptionsDialog_Share(FRDPOptionsDialog *parent_element)
{
   m_boxsizer_1 = NULL;
   m_boxsizer_2 = NULL;
   m_boxsizer_3 = NULL;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_Share::Build()
{
   if ( error == 0 )
   {
      bool state = false;
	 ...
	 m_static_linux_devices = new wxStaticText(this, wxID_ANY,
						   _("&Redirect devices for linux (see man for xfreerdp)"),
						   wxDefaultPosition, wxDefaultSize);
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Share::~FRDPOptionsDialog_Share()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog_Share::Get_Options()
{
   Options_HashMap local_options;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog_Share::SetOptions(const Options_HashMap *all_options)
{
   Options_HashMap local_options;
   local_options = *all_options;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Program::FRDPOptionsDialog_Program(FRDPOptionsDialog *parent_element)
{
   m_boxsizer_1 = NULL;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_Program::Build()
{
   if ( error == 0 )
   {
      bool state = false;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Program::~FRDPOptionsDialog_Program()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog_Program::Get_Options()
{
   Options_HashMap local_options;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog_Program::SetOptions(const Options_HashMap *all_options)
{
   Options_HashMap local_options;
   local_options = *all_options;
   if (m_text_program)
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Program::checkbox_program()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Program::checkbox_program_func(wxCommandEvent &event)
{
   checkbox_program();
}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Performance::FRDPOptionsDialog_Performance(FRDPOptionsDialog *parent_element)
{
   m_boxsizer_1 = NULL;
   m_boxsizer_2 = NULL;
   m_boxsizer_3 = NULL;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_Performance::Build() {
   if (error == 0) {
	 ...
	 m_static_speed  = new wxStaticText(this, wxID_ANY, _("Connection speed"),
					    wxDefaultPosition, wxDefaultSize);
	 ChoisesSpeed[0] = _("Modem 56 Kbps");
	 ChoisesSpeed[1] = _("Broadband 128Kbps - 1.5 Mbps");
	 ChoisesSpeed[2] = _("LAN 10 Mbps or higher");
	 m_choise_speed = new wxComboBox(this,ID_FRDP_COMBOBOX_SPEED,wxT(""),
					 wxDefaultPosition,wxSize(220,-1),3,ChoisesSpeed,wxCB_READONLY) ;
	 ...
	 m_boxsizer_2->Add(m_static_speed, 0,
			   wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	 m_boxsizer_2->Add(m_choise_speed, 0,
			   wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Performance::~FRDPOptionsDialog_Performance()
{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog_Performance::Get_Options()
{
	Options_HashMap local_options;
	if (m_choise_speed)
	{
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog_Performance::SetOptions(const Options_HashMap *all_options)
{
	Options_HashMap local_options;
	local_options = *all_options;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Performance::choise_speed() {
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
void FRDPOptionsDialog_Performance::choise_speed_func(wxCommandEvent &event)
{
	choise_speed();
}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Advanced::FRDPOptionsDialog_Advanced(FRDPOptionsDialog *parent_element)
{
	m_boxsizer_1 = NULL;
	m_boxsizer_2 = NULL;
	m_boxsizer_3 = NULL;
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
int FRDPOptionsDialog_Advanced::Build() {
	if ( error == 0 ) {
		const bool state = Create(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
		if ( state == false) {
			error = FRDP_ERROR_CANT_CREATE_PANEL;
...
//			m_static_rdpversion = new wxStaticText(this, wxID_ANY, _("Choise FRDP version"),
//												   wxDefaultPosition, wxDefaultSize);
//			wxString ChoiseVersion[] = {_("Use FRDP 4"),_("Use FRDP 5"),_("Use FRDP 6")};
...
//														 wxDefaultPosition, wxDefaultSize );
			mCheckboxClipboardSync = new wxCheckBox(this,wxID_ANY,_("&Clipboard sync"));
			mCheckboxClipboardSync->SetToolTip(_("Synchronize client and server clipboard data. Plain text, Unicode text, HTML content and images are supported."));
			mCheckboxClipboardSync->SetValue(true);
			m_checkbox_enablecompress = new wxCheckBox(this,wxID_ANY,_("&Enable compress"),
													   wxDefaultPosition, wxDefaultSize);
			m_static_keyboard_map = new wxStaticText(this, wxID_ANY, _("Keyboard layout"),
													 wxDefaultPosition, wxDefaultSize);
#ifdef __WXGTK__
			wxArrayString listKeyboard;
			...
			if (kbdList.Init())
			{
			   ...
			   {
			      if (!kbdList.GetValueByIndex(index).IsEmpty())
				 listKeyboard.Add(kbdList.GetValueByIndex(index));

			   }
			}
			listKeyboard.Sort();
			listKeyboard.Insert(wxT(""),0);
			m_combobox_keyboard_map = new wxComboBox(this, wxID_ANY,wxT(""),
								 wxDefaultPosition, wxDefaultSize,
								 listKeyboard,wxCB_READONLY,
								 wxDefaultValidator,wxT(""));
			m_combobox_keyboard_map->SetValue(listKeyboard[0]);
			...
			//				   wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
			m_gridsizer_1->Add(mCheckboxClipboardSync, 1,
					   wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
FRDPOptionsDialog_Advanced::~FRDPOptionsDialog_Advanced()
{
   ...
   if (mCheckboxClipboardSync != NULL) {delete mCheckboxClipboardSync; mCheckboxClipboardSync = NULL;}
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
Options_HashMap FRDPOptionsDialog_Advanced::Get_Options()
{
	Options_HashMap local_options;
	...
	// }
	if (mCheckboxClipboardSync != NULL)
	{
	   local_options[wxT("clipboard_sync")] = wxString::Format(wxT("%i"),
								 mCheckboxClipboardSync->GetValue());
	}
	...
	{
	   local_options[wxT("keyboard")] = m_combobox_keyboard_map->GetValue();
...
//! \sa
///////////////////////////////////////////////////////////////////////////////
bool FRDPOptionsDialog_Advanced::SetOptions(const Options_HashMap *all_options) {
	...
	mCheckboxClipboardSync->SetValue(wxAtoi(local_options[wxT("clipboard_sync")]));

	m_checkbox_enablecompress->SetValue(wxAtoi(local_options[wxT("enable_compres")]));

	m_combobox_keyboard_map->SetValue(local_options[wxT("keyboard")]);
//SetSelection(wxAtoi(local_options[wxT("keyboard")]));

...
protected:
	...
	charstring          m_csClearPassword;
	charstring          m_proxyhost;
	ULONG				m_proxyport;
	BOOL                m_scale;
	BOOL                m_fullscreen;
	BOOL                m_shared;
...
public:
	STDMETHOD(put_Scale)(VARIANT_BOOL newVal);
	STDMETHOD(put_FullScreen)(VARIANT_BOOL newVal);
	STDMETHOD(put_Shared)(VARIANT_BOOL newVal);
	STDMETHOD(put_ProxyHost)(BSTR newVal);
	STDMETHOD(put_ProxyPort)(ULONG newVal);
	STDMETHOD(put_ViewOnly)(VARIANT_BOOL newVal);

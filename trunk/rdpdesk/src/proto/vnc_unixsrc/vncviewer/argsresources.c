...
static XtResource appDataResourceList[] = {
  ...
  {"window_id", "WindowId", XtRInt, sizeof(int),
   XtOffsetOf(AppData, window_id), XtRImmediate, (XtPointer) 0},

  {"window_parent", "WindowParent", XtRInt, sizeof(int),
   XtOffsetOf(AppData, window_parent), XtRImmediate, (XtPointer) 0},

   {"title", "Title", XtRString, sizeof(String),
   XtOffsetOf(AppData, title), XtRImmediate, (XtPointer) 0},
...
XrmOptionDescRec cmdLineOptions[] = {
  ...
  {"-window_id",       "*window_id",       XrmoptionSepArg, 0},
//  {"-window_parent",       "*window_parent",       XrmoptionSepArg, 0},
